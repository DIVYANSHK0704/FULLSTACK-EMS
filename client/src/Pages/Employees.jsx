    ...
    <div className="animate fade-in">
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-6">
        ...
        <div className="relative flex-1">
          ...
          <input placeholder="Search Employees...." className="w-full pl-10!" onChange={(e) => {
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-3xl my-8 animate-fade-in" onClick={(e) =>e.stopPropagation()}>
            ...
            <div className="flex items-center justify-between p-6 pb-0">
              ...
              <div>
                ...
                <h2 className="text-lg font-semibold text-slate-600">Add New Employee</h2>
        ...
        <div className="fixed bg-black/40 backdrop-blur-sm inset-0 z-50 flex items-start justify-center p-4 overflow-y-auto" onClick={() => setEditEmployee(null)}>
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-3xl my-8 animate-fade-in" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="flex items-center justify-between p-6 pb-0">
                ...
                <h2 className="text-lg font-semibold text-slate-600">Edit Employee</h2>

                <p className="text-sm text-slate-500 mt-0.5">Update employee details</p>

              </div>

              <button onClick={() =>setEditEmployee
                (null)} className="p-2 rounded-lg hover:bg-slate-100 transition-colors text-slate-400 hover:text-slate-600">
                <X className="w-5 h-5" />
              </button>
