  ...
  return (
    ...
    >
      ...
      <div className="card p-5 sm:p-6">
        ...
        <h3 className="text-base font-medium text-slate-600 mb-6 pb-4 border-b border-slate-100">
          Account Setup
        </h3>
      ...
      <div className="flex flex-col-reverse sm:flex-row justify-end gap-3 pt-2">
        ...
        <button className="btn-primary flex items-center justify-center" type="submit"
        disabled={loading}>
