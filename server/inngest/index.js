...
export const inngest = new Inngest({ id: "fullstack-ews" });

//auto check-out for emp
          ...
          ({
            ...
            body:   `
                        <div style="max-width: 600px; font-family: Arial, sans-serif;">
                            ...
                            <p style="font-size: 16px;">We noticed you haven't marked your attendance yet today.
                            </p>

                            <p style="font-size: 16px;">The deadline was <strong>11:30 AM</strong> and your attendance is still missing.
                            </p>

                            <p style="font-size: 16px;">Please check in as soon as possible or contact your admin if you're facing any issues.
                            </p>
